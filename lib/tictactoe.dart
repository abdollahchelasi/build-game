      ...
      appBar: AppBar(
        actions: [
          Container(
              ...
              child: Image.asset('assets/tic.png',)),
          Container(
              width: size.width*.08,
              margin: EdgeInsets.symmetric(horizontal: 5),
              height: size.height*.1,
        ...
        title: Text('Tic Tac Toe ساخت بازی',style: TextStyle(package: 'google_fonts_arabic',fontFamily: ArabicFonts.Katibeh,fontWeight: FontWeight.bold,color: Colors.amber[100],fontSize: size.width*.05),),
      ),
          ...
          children: [
            ...
            Directionality(
              ...
              child: Container(
                  ...
                  child: Text("""من قبلاً تقریباً با همین منطق کدی را در پایتون در اینجا ایجاد کرده ام:
    ...
    game.main_menu();
            ...
            Directionality(
              ...
              child: Container(
                  ...
                  margin: EdgeInsets.symmetric(horizontal: 20),
                  child: Text("""کد یا "تقریباً یکسان" است ، یا "مشابه" است. "تقریباً مشابه" به نظر می رسد "کاملاً متفاوت" :) به هر حال از متغیرهای یک حرف اجتناب کنید ، یا حداقل "L" کوچک ، من آن را به عنوان "one" می خوانم .
                  """,style: TextStyle(color: Colors.teal[200],fontWeight: FontWeight.bold,package: 'google_fonts_arabic',fontFamily: ArabicFonts.Markazi_Text,fontSize: size.width*.05),)
              ),
            ),
