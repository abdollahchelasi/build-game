...
Game.cpp:
در این حالت بازهم برخی ثابتهای جادویی دارید: "images // background.png". در اینجا منطقی است که این را به صورت ثابت قرار دهید ، به این ترتیب ، بعداً می توانید از یک مولد کد برای ایجاد این ثابت ها بر اساس تصاویر واقعی استفاده کنید (یا حتی آنها را تعبیه کنید) و در صورت از بین رفتن ، در تنظیمات با شکست مواجه می شوید.
